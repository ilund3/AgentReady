			...
			<DialogContent className="sm:max-w-7xl min-h-[75vh]">
				...
				<DialogHeader>
					<DialogTitle className="text-2xl text-center">
						Welcome To AgentReady Cloud 🎉
					</DialogTitle>
					<DialogDescription className="text-center max-w-xl mx-auto">
						Thank you for choosing AgentReady Cloud! 🚀 We're excited to have you
								...
								<div className="flex flex-col gap-2 border p-4 rounded-lg">
									...
									<div>
										<p className="text-primary text-sm font-medium">
											...
											(VPS) to proceed. Use any provider that supports Ubuntu or
											Debian.
										</p>
										<ul className="list-inside list-disc pl-4 text-sm text-muted-foreground mt-4">
											<li>Hostinger</li>
											<li>American Cloud</li>
											<li>DigitalOcean</li>
											<li>Hetzner</li>
											<li>Vultr</li>
											<li>Linode</li>
								...
								return (
									<div className="flex flex-col gap-6">
										<div className="flex flex-col gap-2">
											...
											<p className="text-muted-foreground">
												Here are some of the things you can do with AgentReady
												Cloud:
											</p>
										</div>
										...
										<div className="flex flex-col gap-2 mt-4">
											<span className="text-base text-primary">
												Need help? Check your dashboard settings for support options.
											</span>
										</div>
									</div>
								);
