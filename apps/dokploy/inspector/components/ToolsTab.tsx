import { Alert, AlertDescription, AlertTitle } from "@inspector/components/ui/alert";
import { Button } from "@inspector/components/ui/button";
import { Checkbox } from "@inspector/components/ui/checkbox";
import { Input } from "@inspector/components/ui/input";
import { Label } from "@inspector/components/ui/label";
import { TabsContent } from "@inspector/components/ui/tabs";
import { Textarea } from "@inspector/components/ui/textarea";
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from "@inspector/components/ui/select";
import DynamicJsonForm, { DynamicJsonFormRef } from "./DynamicJsonForm";
import type { JsonValue, JsonSchemaType } from "@inspector/utils/jsonUtils";
import {
  generateDefaultValue,
  isPropertyRequired,
  normalizeUnionType,
  resolveRef,
} from "@inspector/utils/schemaUtils";
import {
...
import useCopy from "@inspector/lib/hooks/useCopy";
import IconDisplay, { WithIcons } from "./IconDisplay";
import { cn } from "@inspector/lib/utils";
import {
  ...
  hasValidMetaPrefix,
  isReservedMetaKey,
} from "@inspector/utils/metaUtils";
